//
//  HCDSH_search_list_ViewController.m
//  Factory
//
...
@interface HCDSH_search_list_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation HCDSH_search_list_ViewController
