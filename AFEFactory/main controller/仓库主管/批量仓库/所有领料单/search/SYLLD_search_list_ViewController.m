//
//  SYLLD_search_list_ViewController.m
//  Factory
//
...
@interface SYLLD_search_list_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation SYLLD_search_list_ViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)loddeList{
    ...
    dic = @{@"businessId":[Manager redingwenjianming:@"bianhao.text"],
            ...
            @"materialNo":self.str1,
            @"orderNo":self.str2,
            @"productionOrderNo":self.str3,
            @"status":self.str4,
            };
