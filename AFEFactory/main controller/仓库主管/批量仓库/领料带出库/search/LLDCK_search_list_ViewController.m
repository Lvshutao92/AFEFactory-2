//
//  LLDCK_search_list_ViewController.m
//  Factory
//
...
@interface LLDCK_search_list_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation LLDCK_search_list_ViewController
- (void)viewDidLoad {
    [super viewDidLoad];
