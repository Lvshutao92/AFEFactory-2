...
#import "Edit_ChaCheGong_ViewController.h"
@interface BJRKD_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation BJRKD_ViewController
...
- (void)clickbtn1:(UIButton *)sender{
    ...
    if (model.forkliftPerson_model.personCode == nil) {
        ...
        chachegong.textstr   = [NSString stringWithFormat:@"%@ %@",model.receivePerson_model.personCode,model.receivePerson_model.realName];;
