//
//  XHRKD_search_list_ViewController.m
//  Factory
//
...
@interface XHRKD_search_list_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation XHRKD_search_list_ViewController
...
//    NSLog(@"%@\n%@\n%@\n%@\n%@\n%@\n%@\n%@",self.str1,self.str2,self.str3,self.str4,self.str5,self.str6,self.str7,self.str8);
    [self setUpReflash];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (model.purchasePaymentOrder_model.confirmTime  == nil) {
        cell.lab11.text = [NSString stringWithFormat:@"发票确认时间：%@",@"-"];
    }else{
