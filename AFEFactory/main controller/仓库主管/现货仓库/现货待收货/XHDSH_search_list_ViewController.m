//
//  XHDSH_search_list_ViewController.m
//  Factory
//
...
@interface XHDSH_search_list_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation XHDSH_search_list_ViewController
