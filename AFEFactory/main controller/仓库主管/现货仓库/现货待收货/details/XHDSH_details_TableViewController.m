//
//  XHDSH_details_TableViewController.m
//  Factory
//
...
@interface XHDSH_details_TableViewController ()
{
    CGFloat height;
    CGFloat height1;
}
...
@implementation XHDSH_details_TableViewController
...
//                        NSLog(@"---%@",dic);
        ...
        for (NSDictionary *dict in arr) {
            ...
            PaidanModel1 *model1 = [PaidanModel1 mj_objectWithKeyValues:model.productSku];
            model.productSku_model = model1;
