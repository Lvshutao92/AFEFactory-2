//
//  SHDSH_search_list_ViewController.m
//  AFEFactory
//
...
@interface SHDSH_search_list_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation SHDSH_search_list_ViewController
