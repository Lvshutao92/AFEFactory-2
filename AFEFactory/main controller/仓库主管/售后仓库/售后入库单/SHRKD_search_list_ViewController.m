//
//  SHRKD_search_list_ViewController.m
//  AFEFactory
//
...
@interface SHRKD_search_list_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation SHRKD_search_list_ViewController
...
//     NSLog(@"%@",[dic objectForKey:@"purchaseOrder.supplierNo"]);
