//
//  CGGL_search_list_ViewController.m
//  AFEFactory
//
...
@interface CGGL_search_list_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation CGGL_search_list_ViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)loddeList{
    ...
    dic = @{@"businessId":[Manager redingwenjianming:@"bianhao.text"],
            ...
            @"purchasePlanNo":self.str1,
            @"order.orderNo":self.str2,
            @"orderStatus":self.str3,
            };
//     NSLog(@"%@",dic);
