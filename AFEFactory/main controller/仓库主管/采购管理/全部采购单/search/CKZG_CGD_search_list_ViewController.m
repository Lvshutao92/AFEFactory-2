//
//  CKZG_CGD_search_list_ViewController.m
//  AFEFactory
//
...
@interface CKZG_CGD_search_list_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation CKZG_CGD_search_list_ViewController
...
- (void)loddeList{
    ...
    dic = @{@"businessId":[Manager redingwenjianming:@"bianhao.text"],
            ...
            @"orderNo":self.str1,
            @"purchaseOrderNo":self.str2,
            @"originalPurchaseOrderNo":self.str3,
            @"purchasePlanNo":self.str4,
            @"supplierNo":self.str5,
            @"purchaseOrderType":self.purchaseOrderType,
            @"status":self.str6,
            };
//    NSLog(@"%@",dic);
