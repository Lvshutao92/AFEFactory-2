//
//  GCCPCGLY_PaiDan_ViewController.m
//  AFEFactory
//
...
@interface GCCPCGLY_PaiDan_ViewController ()

@end

@implementation GCCPCGLY_PaiDan_ViewController
...
- (void)clicksearch{
    if ([Manager sharedManager].index_renshi == 1000) {
        ...
        NSNotification *notification =[NSNotification notificationWithName:@"cheng_pin_cang__PiLiangDingDan" object:nil userInfo:dict];
        [[NSNotificationCenter defaultCenter] postNotification:notification];
    }else {
        NSDictionary *dict = [[NSDictionary alloc]init];
        NSNotification *notification =[NSNotification notificationWithName:@"cheng_pin_cang__PaiDanJiHua" object:nil userInfo:dict];
        [[NSNotificationCenter defaultCenter] postNotification:notification];
    }
}
