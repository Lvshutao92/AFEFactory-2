...
@interface SuoyouWeixiu_ViewController ()<UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource,UIGestureRecognizerDelegate>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation SuoyouWeixiu_ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.btn2 setTitle:@"维修确认" forState:UIControlStateNormal];
    [cell.btn3 setTitle:@"维修费用" forState:UIControlStateNormal];
...
- (void)clickbtn2:(UIButton *)sender{
    ...
    edit.navigationItem.title = @"确认维修";
    edit.idstr = model.id;
    edit.str1 = model.field2;
...
- (void)clickbtn3:(UIButton *)sender{
    ...
    edit.navigationItem.title = @"维修费用";
    edit.idstr = model.id;
    edit.str1 = model.field2;
    [self.navigationController pushViewController:edit animated:YES];
}
- (void)clickbtn4:(UIButton *)sender{
    ...
    edit.navigationItem.title = @"维修审核";
    edit.idstr = model.id;
