//
//  BaoYangMingXi_ViewController.m
//  AFEFactory
//
...
@interface BaoYangMingXi_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
    NSString *idstring;
    NSInteger page;
...
@implementation BaoYangMingXi_ViewController


- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"保养明细";
...
- (void)loddeList{
    ...
    [session POST:KURLNSString(@"servlet/equipment/equipmentmaintaindetail/list") parameters:dic constructingBodyWithBlock:nil progress:^(NSProgress * _Nonnull uploadProgress) {
