...
@interface WDWP_A_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation WDWP_A_ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.lab6.text = [NSString stringWithFormat:@"数量：%@",model.num];
    
    cell.lab7.text = [NSString stringWithFormat:@"单位：%@",model.unit];
    
    
    cell.lab8.text = [NSString stringWithFormat:@"领用时间：%@",[Manager TimeCuoToTimes:model.takeTime]];
