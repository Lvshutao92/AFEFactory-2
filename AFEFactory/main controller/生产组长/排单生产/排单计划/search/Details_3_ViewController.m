...
@interface Details_3_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
}
...
@implementation Details_3_ViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)lod3{
    ...
    dic = @{@"businessId":[Manager redingwenjianming:@"bianhao.text"],
            @"orderNo":[Manager sharedManager].ids,
            @"sorttype":@"asc",
            @"sort":@"undefined",
            };
    [session POST:KURLNSString(@"servlet/production/productionplanlog/list") parameters:dic constructingBodyWithBlock:nil progress:^(NSProgress * _Nonnull uploadProgress) {
