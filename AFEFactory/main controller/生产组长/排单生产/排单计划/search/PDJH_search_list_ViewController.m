//
//  PDJH_search_list_ViewController.m
//  Factory
//
...
@interface PDJH_search_list_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation PDJH_search_list_ViewController
