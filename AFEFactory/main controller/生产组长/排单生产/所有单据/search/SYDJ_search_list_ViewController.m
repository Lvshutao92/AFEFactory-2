//
//  SYDJ_search_list_ViewController.m
//  Factory
//
...
@interface SYDJ_search_list_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation SYDJ_search_list_ViewController
