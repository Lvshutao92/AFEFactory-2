...
@interface SCBZ_YWC_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation SCBZ_YWC_ViewController
...
//    }
    ...
    if (model.field8 == nil) {
        ...
        if ([dic objectForKey:@"deliveryDate"] == nil) {
            ...
            cell.lab6.text = [NSString stringWithFormat:@"预计提货日期：%@",[dic objectForKey:@"deliveryDate"]];
        }
    ...
    if (model.serviceCompanyName == nil) {
        cell.lab7.text = [NSString stringWithFormat:@"装卸服务商：%@",@"-"];
    }else{
        cell.lab7.text = [NSString stringWithFormat:@"装卸服务商：%@",model.serviceCompanyName];
    }
    
    
    if (model.field15 == nil) {
        cell.lab8.text = [NSString stringWithFormat:@"装卸费用：%@",@"-"];
    }else{
        
        cell.lab8.text = [NSString stringWithFormat:@"装卸费用：%@",[NSString stringWithFormat:@"¥ %.2f",[model.field15 floatValue]]];
    }
