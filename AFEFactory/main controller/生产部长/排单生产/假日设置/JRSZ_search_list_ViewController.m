//
//  JRSZ_search_list_ViewController.m
//  AFEFactory
//
...
@interface JRSZ_search_list_ViewController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation JRSZ_search_list_ViewController
...
- (void)loddeList{
    ...
    dic = @{@"businessId":[Manager redingwenjianming:@"bianhao.text"],
            ...
            @"holidayDay":self.str1,
            @"holidayWeek":self.str2,
