//
//  PLDD_three_details_ViewController.m
//  AFEFactory
//
...
@interface PLDD_three_details_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
}
...
@implementation PLDD_three_details_ViewController
- (void)viewDidLoad {
    [super viewDidLoad];
