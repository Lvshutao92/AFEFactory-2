//
//  PLDD_four_details_ViewController.m
//  AFEFactory
//
...
@interface PLDD_four_details_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
}
...
@implementation PLDD_four_details_ViewController
- (void)viewDidLoad {
    [super viewDidLoad];
