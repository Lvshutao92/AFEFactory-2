//
//  GN_YWC_searchList_ViewController.m
//  AFEFactory
//
...
@interface GN_YWC_searchList_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    CGFloat height;
    NSInteger page;
    NSInteger totalnum;
...
@implementation GN_YWC_searchList_ViewController
