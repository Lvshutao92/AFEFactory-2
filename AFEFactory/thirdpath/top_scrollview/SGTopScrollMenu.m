...
#define labelFontOfSize [UIFont systemFontOfSize:18]
...
/** label之间的间距 */
static CGFloat const labelMargin = 20;
/** 指示器的高度 */
...
- (void)setTitlesArr:(NSArray *)titlesArr {
    ...
    for (NSUInteger i = 0; i < self.titlesArr.count; i++) {
        ...
        // 设置高亮文字颜色
        _titleLabel.highlightedTextColor = RGBACOLOR(32, 157, 149, 1.0);
    ...
    _indicatorView.backgroundColor = RGBACOLOR(32, 157, 149, 1.0);
    _indicatorView.SG_height = indicatorHeight;
    _indicatorView.SG_y = self.frame.size.height - indicatorHeight;
    [self addSubview:_indicatorView];
    
//    UILabel *lab = [[UILabel alloc]initWithFrame:CGRectMake(0, 41.5, 10000, .3)];
